...
### File List
**New Files Created:**
- `apps/web/src/components/map/ApplicationPin.tsx` - Planning application pin component with house icon
...
- `tests/components/map/ApplicationPin.test.tsx` - Unit tests for application pin
...
**Modified Files:**
- `apps/web/src/components/map/CommentPin.tsx` - Updated sentiment colors to match story spec
- `apps/web/src/components/map/index.ts` - Added exports for new components
- `apps/web/src/app/comments/[applicationId]/page.tsx` - Integrated map section
- `docs/stories/2.2.story.md` - Updated task completion and status
